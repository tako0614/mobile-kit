...
- Scope: Product-agnostic mobile foundation and vendored mobile wire-contract shared by mobile shells.
...
- Owns: Product-agnostic host discovery, handoff, OIDC, and session foundation / Typed native bridge helpers and shared Solid mobile shell / Vendored mobile discovery contract mirror and conformance fixtures
- Does not own: Product APIs, content, or UI / Native push, call, or plugin implementations / The owning Takosumi host wire contract
- Hazards: The repository and package identity is mobile-kit, not Takosumi Mobile Kit. / The community remote-push adapter remains non-shipping and feature-off.
